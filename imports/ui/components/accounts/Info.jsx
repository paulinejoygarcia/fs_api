    ...
    saveInfo(e) {
        ...
        if (this.firstName.value.trim() !== "" && this.lastName.value.trim()) {
            ...
            Meteor.call(UsersSave, this.firstName.value.trim(), this.lastName.value.trim(), (err) => {
                if (err)
                    Util.showGritter('Saving Info', err.reason, GRITTER_STATUS.WARNING);
                else
                    Util.showGritter('Saving Info', "Saving info successful!", GRITTER_STATUS.SUCCESS);
    ...
    changePass(e) {
        ...
        if (this.npass1.value.trim().length >= 6 && this.npass2.value.trim() === this.npass1.value.trim()) {
            ...
            Meteor.call(UsersSavePassword, this.npass1.value.trim(), (err) => {
                if (err)
                    Util.showGritter('Changing Password', err.reason, GRITTER_STATUS.WARNING);
                else {
                    this.npass1.value = "";
                    this.npass2.value = "";
                    Util.showGritter('Changing Password', "Saving info successful!", GRITTER_STATUS.SUCCESS);
                }
                this.setState({ saving: false });
            });
        }
        else
            Util.showGritter('Changing Password', "Password must matched and  have more than 5 characters.", GRITTER_STATUS.WARNING);
    }
                ...
                <div className="widget p-4">
                    ...
                    <form className="mb-4" onSubmit={this.saveInfo.bind(this)}>
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <input type="text" placeholder="First Name" className="form-control" ref={(e) => {
                                        this.firstName = e;
                                    }}/>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="form-group">
                                    <input type="text" placeholder="Last Name" className="form-control" ref={(e) => {
                                        this.lastName = e;
                                    }}/>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <input type="text" disabled readOnly placeholder="Email" className="form-control"
                                           ref={(e) => {
                                               this.email = e;
                                           }}/>
                                </div>
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <input type="text" disabled readOnly placeholder="ASTPP ID" className="form-control"
                                           ref={(e) => {
                                               this.astpp = e;
                                           }}/>
                                </div>
                    ...
                    <form className="mb-4" onSubmit={this.changePass.bind(this)}>
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <input type="password" placeholder="Password" className="form-control" ref={(e) => {
                                        this.npass1 = e;
                                    }}/>
                                </div>
                            </div>
